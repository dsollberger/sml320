...
$$\ds\lim_{n \to \infty} P(N_{t} = k) = \ds\lim_{n \to \infty} \binom{n}{k} \left(\ds\frac{\lambda t}{n}\right)^{k} \left(1 - \ds\frac{\lambda t}{n}\right)^{n} \left(1 - \ds\frac{\lambda t}{n}\right)^{-k}$$

## Partial Proof

Handling the limit by its factors:
$$\ds\lim_{n \to \infty} \left(1 - \ds\frac{\lambda t}{n}\right)^{-k} = 1, \quad \ds\lim_{n \to \infty} \left(1 - \ds\frac{\lambda t}{n}\right)^{n} = e^{-\lambda t}$$

$$\begin{array}{rcl}
  \ds\lim_{n \to \infty} \binom{n}{k} \left(\ds\frac{\lambda t}{n}\right)^{k} & = & (\lambda t)^{k} \ds\lim_{n \to \infty} \binom{n}{k} \left(\ds\frac{1}{n}\right)^{k} \\
...
$$\text{E}(\lambda) = \ds\frac{s}{r} = 20$$
$$\text{Var}(\lambda) = \ds\frac{s}{r^{2}} = 5^{2}$$
...
* [Tips received during my 10 Months as a Server](https://old.reddit.com/r/dataisbeautiful/comments/1ajfe7j/tips_received_during_my_10_months_as_a_serveroc/)
